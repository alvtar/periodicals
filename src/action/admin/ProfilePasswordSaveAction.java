...
public class ProfilePasswordSaveAction extends AuthorizedUserAction {
    private static Logger logger = Logger.getLogger(ProfilePasswordSaveAction.class);
        ...
        if (oldPassword != null && newPassword != null) {
            ...
            if (user != null) {
                ...
                logger.info(String.format(
                        "User \"%s\" tried to change password and specified the incorrect previous password",
                        authorizedUser.getLogin()));
            }
        } else {
            logger.warn(String.format("Incorrect data was found when user \"%s\" tried to change password",
                    authorizedUser.getLogin()));
        }
        return forward;
    }
