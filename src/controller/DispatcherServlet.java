...
public class DispatcherServlet extends HttpServlet {
    ...
    public static final Level LOG_LEVEL = Level.DEBUG; // Logging all events
                                                       // include Debug (many
                                                       // messages in console)
    // public static final Level LOG_LEVEL = Level.WARN; // Logging only
                                                         // Warning, Error & Fatal evens
    ...
    private void process(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (forward != null && forward.isRedirect()) {
                ...
                logger.debug(String.format("Request for URI \"%s\" id redirected to URI \"%s\"", requestedUri,
                        redirectedUri));
